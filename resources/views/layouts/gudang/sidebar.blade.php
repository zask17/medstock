    ...
    <nav class="flex-1 px-4 space-y-1 overflow-y-auto pb-4 custom-scrollbar">
        ...
        <details class="group [&_summary::-webkit-details-marker]:hidden" open>
            ...
            <div class="mt-1 ml-5 pl-4 border-l border-gray-100 flex flex-col space-y-1">
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Daftar Pembelian</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Pembayaran</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Retur Pembelian</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Terima Retur</a>
            </div>
        </details>
        ...
        <details class="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <div class="mt-1 ml-5 pl-4 border-l border-gray-100 flex flex-col space-y-1">
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Daftar Produk</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Kerusakan Produk</a>
            </div>
        </details>
        ...
        <details class="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <div class="mt-1 ml-5 pl-4 border-l border-gray-100 flex flex-col space-y-1">
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Laporan Penjualan</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Laporan Retur Penjualan</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Laporan Pembelian</a>
            </div>
        </details>
        ...
        <details class="group [&_summary::-webkit-details-marker]:hidden" open>
            ...
            <div class="mt-1 ml-5 pl-4 border-l border-gray-100 flex flex-col space-y-1">
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Laporan Stok</a>
                <a href="#" class="py-2 px-3 text-sm text-gray-500 hover:text-[#149387] rounded-lg transition-colors">Laporan Batch Stok</a>
            </div>
        </details>
