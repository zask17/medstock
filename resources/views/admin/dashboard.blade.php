...
<div class="space-y-6">
    <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4 sm:gap-6">
        <div class="bg-white p-6 rounded-3xl shadow-xs border border-gray-100 flex items-center justify-between">
            <div>
                <p class="text-gray-400 text-sm font-medium">Total Customer</p>
                <h3 class="text-3xl font-bold text-gray-800 mt-1">120</h3>
                <a href="#" class="text-[#149387] text-xs font-semibold mt-3 block hover:underline">Show Details</a>
            </div>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-xs border border-gray-100 flex items-center justify-between">
            <div>
                <p class="text-gray-400 text-sm font-medium">Total Sals</p>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-xs border border-gray-100 flex items-center justify-between">
            <div>
                <p class="text-gray-400 text-sm font-medium">Total Profit</p>
        ...
        <div class="bg-white p-6 rounded-3xl shadow-xs border border-gray-100 flex items-center justify-between">
            <div>
                <p class="text-gray-400 text-sm font-medium">Out of Stock</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="bg-white rounded-3xl p-6 shadow-xs border border-gray-100">
            <div class="flex justify-between items-center mb-6">
                <h3 class="font-bold text-gray-800 text-lg">Expiring List</h3>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm min-w-[550px]">
                    <thead class="text-gray-400 border-b border-gray-100 text-xs">
                        <tr>
                            <th class="pb-3 pr-2 font-medium">Medicine name <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 px-2 font-medium">Expire Date <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 px-2 font-medium">Quantity <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 px-2 font-medium">Chart <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 pl-2 font-medium text-right">Return <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                        </tr>
                    </thead>
        ...
        <div class="bg-white rounded-3xl p-6 shadow-xs border border-gray-100">
            <div class="flex justify-between items-center mb-6">
                <h3 class="font-bold text-gray-800 text-lg">Recent Order's</h3>
                <a href="#" class="text-[#149387] text-xs font-bold flex items-center gap-1 hover:underline">See All <i class="fa-solid fa-chevron-right text-[10px]"></i></a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-left text-sm min-w-[550px]">
                    <thead class="text-gray-400 border-b border-gray-100 text-xs">
                        <tr>
                            <th class="pb-3 pr-4 font-medium">Medicine name <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 px-3 font-medium">Batch No <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 px-3 font-medium">Quantity <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 px-3 font-medium">Status <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                            <th class="pb-3 pl-4 font-medium text-right">Price <i class="fa-solid fa-arrows-up-down text-[9px] ml-0.5"></i></th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-gray-50 text-gray-600 text-sm">
                        @php
                        ...
                        <tr class="hover:bg-gray-50/50 transition-all">
                            ...
                            <td class="py-4 px-3">
                                @if($order['status'] === 'Delivered')
                                    <span class="bg-indigo-50 text-indigo-600 px-2.5 py-1 rounded-md text-[10px] font-bold">Delivered</span>
                                @elseif($order['status'] === 'Pending')
                                    <span class="bg-amber-50 text-amber-500 px-2.5 py-1 rounded-md text-[10px] font-bold">Pending</span>
                                @else
                                    <span class="bg-rose-50 text-rose-500 px-2.5 py-1 rounded-md text-[10px] font-bold">Cancelled</span>
                                @endif
                            </td>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
        <div class="bg-white rounded-3xl p-6 shadow-xs border border-gray-100 xl:col-span-2">
            <div class="flex justify-between items-center mb-4">
                <h3 class="font-bold text-gray-800 text-lg">Monthly Progress</h3>
        ...
        <div class="bg-white rounded-3xl p-6 shadow-xs border border-gray-100">
            <h3 class="font-bold text-gray-800 text-lg mb-2">Today's Report</h3>
            <div class="relative flex flex-col items-center justify-center">
                <div class="w-48 h-48">
                    <canvas id="todaysReportChart"></canvas>
                </div>
                <div class="absolute top-[34%] text-center">
                    <p class="text-xs text-gray-400 font-medium">Total Earning</p>
            ...
            <div class="grid grid-cols-2 gap-2 text-xs mt-4 pl-4 text-gray-500 font-semibold">
                <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-rose-500"></span> Total Purchase</div>
                <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-amber-400"></span> Cash Received</div>
                <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-indigo-600"></span> Bank Receive</div>
                <div class="flex items-center gap-2"><span class="w-2 h-2 rounded-full bg-emerald-500"></span> Total Service</div>
            </div>
        </div>
    </div>
